...
let cantElec = document.getElementById(cantidad);
let cant = document.createElement("p");
cant.innerText = parseInt(cont);
cantidad.append(cant);

let conDiario =document.getElementById(diario);
let pdiario = document.createElement("p");
pdiario.innerText = parseInt(consumo) + "  kwh."
diario.append(pdiario);

let conMensual = document.getElementById(mensual);
let pmes =document.createElement("p");
pmes.innerText = parseInt(consuMes) + "  kwh,"
mensual.append(pmes);
